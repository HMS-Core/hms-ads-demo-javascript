...
AdManager.prototype.reportAdClick = function (adId) {
  if (adId && this.nativeAd) {
...
AdManager.prototype.reportAdShow = function (adId) {
  if (adId && this.nativeAd) {
...
AdManager.prototype.reportAdClose = function (adId) {
  if (adId && this.nativeAd) {
    this.nativeAd.reportAdClose({
      adId: adId,
    });
  }
};

AdManager.prototype.onAdClick = function (adId) {
  if (adId && this.nativeAd) {
    this.nativeAd.onAdClick({
      adId: adId,
    });
  }
};
...
AdManager.prototype.startDownload = function (adId) {
  if (adId && this.nativeAd) {
    this.nativeAd.startDownload({
      adId: adId,
    });
  }
};
